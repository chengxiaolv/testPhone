<template>
  <div class="CommodityDetailsContent">
    <div class="CollageIintroduction">
      <div class="one">
        <img src="../../../static/images/top-icon-kaituan@2x.png" alt="">
        <p>1.择商品开团/拼团</p>
      </div>
      <div class="Braces">></div>
      <div class="tow">
        <img src="../../../static/images/top-icon-cantuan@2x.png" alt="">
        <p>1.择商品开团/拼团</p>
      </div>
      <div class="Braces">></div>
      <div class="three">
        <img src="../../../static/images/top-icon-chengtuan@2x.png" alt="">
        <p>1.择商品开团/拼团</p>
      </div>
    </div>
    <div class="Price">
      ...
      <ul>
        <li class="clearfix">
          ...
          <div class="fl">
            <p>程晓绿</p>
            <p>
              <span>2018-05-20 18:32:03</span>开团
            </p>
          </div>
        </li>
      </ul>
...
<style scoped lang="scss">
  ...
  .CommodityDetailsContent{
    ...
    .CollageIintroduction{
      ...
      border-bottom: solid pxToRem(2) #eee;
      img{
        width: pxToRem(48);
        height: pxToRem(48);
    ...
    .Price{
      padding: pxToRem(30) pxToRem(36) pxToRem(35) pxToRem(36);
      display: flex;
      .Price_left{
        img{
          width: pxToRem(300);
    ...
    .CommodityDetails{
      padding: pxToRem(30) pxToRem(36) pxToRem(100) pxToRem(36);
      font-size: pxTorem(28);
      color: #333;
    }
    .GroupRecords{
      padding: pxToRem(30) 0 0 pxToRem(36);
      .GroupRecordsTitle{
        font-size: pxToRem(28);
        color: #333;
        padding-bottom: pxToRem(20);
      ...
      ul{
        li{
          padding: pxToRem(22) 0 pxToRem(22) 0;
          img{
            width: pxToRem(100);
            height: pxToRem(100);
            margin-right: pxToRem(20);
